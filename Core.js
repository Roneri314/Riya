...
module.exports = A17 = async (A17, m, chatUpdate, store) => {
  try {
    ...
    const isyuki = [botNumber, ...global.yukio].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
Typed *surrender* to surrender and admited defeat`
  ...
  */
    ...
    const responses = {
      ...
      'trama': `My Boss is lost in another Multiverse, and I lost connection with him...`,
	...
	'هجهج' : '❄️⚡️🔥🌟 هجهج ستار ملك الأفكار',
	    'تستس' : 'يويو',
    };
...
case 'yuki':
      case 'cai': {
        ...
        try {
          const hoshino = await axios.get(`https://skizo.tech/api/cai/chat?apikey=Sora&characterId=oRzFLaIP_QZ7dzal66T9Vpjl8Rhu0oK62cnK7IlIasM&sessionId=v7RflwjJILEVwXnf_NFkApLOmxivpi16TWBe-GGrtIw&token=92e56afa8f0e2b15187f483885bab11342bedd0c&text=${encodeURIComponent(q)} `);
...
*/
      ...
      */
      ...
      case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
        ...
        A17.sendMessage(m.chat, { image: { url: anu }, caption: `Made by yuki Bot By SORA...  🪄` }, { quoted: m })
      }
